...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(Table, null), document.querySelector('#app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Table = function (_React$Component) {
	    ...
	    _createClass(Table, [{
	        key: 'callBack',
	        value: function callBack(cellInfo) {
	            if (cellInfo.sor === this.state.fekete.vizszintes && (cellInfo.oszlop - 1 === this.state.fekete.fuggoleges || cellInfo.oszlop + 1 === this.state.fekete.fuggoleges) || cellInfo.oszlop === this.state.fekete.fuggoleges && (cellInfo.sor - 1 === this.state.fekete.vizszintes || cellInfo.sor + 1 === this.state.fekete.vizszintes)) {
	                this.setState(function (prevState) {
	                    ...
	                    newState.helyzet[[{ stringId: stringId }][0]] = prevState.fekete.vizszintes;
	                    newState.helyzet[[{
	                        stringId: stringId
	        ...
	        value: function positionCellVertically(index) {
	            index = index.toString();
	            return index === this.state.fekete.id ? this.state.fekete.fuggoleges : this.state.helyzet[index][1];
	        }
	    }, {
	        key: 'isBlack',
